	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			mAdapter = new MyExpandableListAdapter(cursor, this,
                    ...
                    R.layout.itemlayout, new String[] { new String("dif_dif".getBytes(),"utf-8") },
                    new int[] { android.R.id.text1 }, new String[] { new String("ranking".getBytes(),"utf-8"),new String("score".getBytes(),"utf-8"), new String("name".getBytes(),"utf-8") },
